    ...
    >
      {inJournal ? (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M11.5 4C11.5 3.58579 11.1642 3.25 10.75 3.25C10.3358 3.25 10 3.58579 10 4V5.75C10 6.16421 10.3358 6.5 10.75 6.5C11.1642 6.5 11.5 6.16421 11.5 5.75V4Z" fill="currentColor"/>
